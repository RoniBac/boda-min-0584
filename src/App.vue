<script setup>
import { invitacion as data } from './config/invitacion'
...
<template>
  ...
  <Reveal :imagen = "data.princpal1.imagen"/>
  ...
  <div class="content">
    <div class="shared-bg2">
      <Itinerario :data="data.itinerario"/>
    </div>
  </div>
  ...
  <div class="content">
    <div class="shared-bg">
      ...
      <Confirmacion :data="data.confirmacion" />
    </div>
  </div>
